        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <h1 className="text-lg sm:text-2xl font-bold text-gray-800">Invoice Generator</h1>
            </div>
            <span className="text-xs sm:text-sm text-gray-500 hidden xs:block">House of Ridhima Kaur</span>
          </div>
        </div>
      </header>
