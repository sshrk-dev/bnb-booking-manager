    ...
    <div className="mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 mb-1">Avg. Booking</p>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900">{stats.platformBreakdown.length}</p>
            </div>
            ...
            {stats.platformBreakdown.map((platform) => (
              <div key={platform.platform} className="border-b border-gray-200 pb-3 last:border-0">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm text-gray-500">{platform.count} bookings</span>
                </div>
          ...
          <div className="space-y-3">
            {stats.recentBookings.length > 0 ? (
              stats.recentBookings.map((booking) => (
                <div key={booking.id} className="flex justify-between items-center border-b border-gray-200 pb-3 last:border-0">
                  <div>
                  ...
                  <span className="text-sm font-medium text-gray-900">{booking.payment}</span>
                </div>
              ))
            ) : (
